class TicketsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ticket.save
        format.html { redirect_to @ticket, notice: 'Bilet został zapisany.' }
  ...
  private
    ...
    def ticket_params
      params.require(:ticket).permit(:name, :address, :price, :email_address, :phone, :seat_id_seq, :event_id, :user_id)
    end
